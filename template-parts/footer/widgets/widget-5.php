<?php
/**
 * The template for displaying the footer widget 5.
 *
 * @package SBHI
 */
...
<div class="f-widget">
	...
	<ul class="social-icons">
		...
		if ( $facebook_url ) {
			printf(
				'<li><a class="facebook" href="%s">%s</a></li>',
		...
		if ( $instagram_url ) {
			printf(
				'<li><a class="instagram" href="%s">%s</a></li>',
		...
		if ( $linkedin_url ) {
			printf(
				'<li><a class="linkedin" href="%s">%s</a></li>',
		...
		if ( $twitter_url ) {
			printf(
				'<li><a class="twitter" href="%s">%s</a></li>',
				esc_url( $twitter_url ),
