                    ...
                    <div class="tutor-dashboard-header">
                        ...
                        <div class="tutor-dashboard-header-button">
                            ...
                            if (tutils()->get_option('enable_become_instructor_btn')) {
                                ?>
                                    <a id="tutor-become-instructor-button" style="vertical-align:middle" class="button button-border" href="<?php echo esc_url(tutils()->instructor_register_url()); ?>">
                            ...
                            if(current_user_can(tutor()->instructor_role)){
                                ...
                                ?>
                                <a class="button button-border" href="<?php echo apply_filters('frontend_course_create_url', admin_url("post-new.php?post_type=".tutor()->course_post_type)); ?>">
